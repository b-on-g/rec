...
declare namespace $ {
    ...
    class $bog_rec_fuzz extends $mol_object {
        ...
        static targets(root: $mol_view, allow?: (view: $mol_view) => boolean): $mol_view[];
        static suits(view: $mol_view, allow?: (view: $mol_view) => boolean): boolean;
        static kinds(view: $mol_view): string[];
        /** Ошибки, которые приложение показало на экране. */
        static errors(root: $mol_view): string[];
        static run(config: $bog_rec_fuzz_config): Promise<$bog_rec_fuzz_report>;
        static fire(view: $mol_view, kind: string, rand: $bog_rec_rand, config: $bog_rec_fuzz_config): void;
        static event(win: typeof globalThis, kind: string, rand: $bog_rec_rand): Event;
...
declare namespace $ {
	...
	type $mol_button_minor__hint_bog_rec_demo_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__title_bog_rec_demo_2 = $mol_type_enforce<
		string
		,
	...
	export class $bog_rec_demo extends $mol_page {
		...
		less( next?: any ): any
		Less( ): $mol_button_minor
		value_text( ): string
		Value( ): $mol_view
		more( next?: any ): any
		More( ): $mol_button_minor
		Counter( ): $mol_row
