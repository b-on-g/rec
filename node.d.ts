...
declare namespace $ {
	...
	type $mol_button_open__hint_bog_rec_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_open['hint'] >
	>
	type $mol_button_open__accept_bog_rec_app_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_open['accept'] >
	>
	type $mol_button_open__multiple_bog_rec_app_3 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_button_open['multiple'] >
	>
	type $mol_button_open__files_bog_rec_app_4 = $mol_type_enforce<
		ReturnType< $bog_rec_app['files'] >
		,
		ReturnType< $mol_button_open['files'] >
	>
	type $mol_button_minor__hint_bog_rec_app_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__title_bog_rec_app_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_rec_app_7 = $mol_type_enforce<
		ReturnType< $bog_rec_app['restart'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__hint_bog_rec_app_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__title_bog_rec_app_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_rec_app_10 = $mol_type_enforce<
		ReturnType< $bog_rec_app['back'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__hint_bog_rec_app_11 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__title_bog_rec_app_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_rec_app_13 = $mol_type_enforce<
		ReturnType< $bog_rec_app['step'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__hint_bog_rec_app_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__title_bog_rec_app_15 = $mol_type_enforce<
		ReturnType< $bog_rec_app['toggle_title'] >
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_rec_app_16 = $mol_type_enforce<
		ReturnType< $bog_rec_app['toggle'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_text__text_bog_rec_app_17 = $mol_type_enforce<
		ReturnType< $bog_rec_app['status'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_list__rows_bog_rec_app_18 = $mol_type_enforce<
		ReturnType< $bog_rec_app['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_rec_app_19 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_rec_app_screen__html_bog_rec_app_20 = $mol_type_enforce<
		ReturnType< $bog_rec_app['screen'] >
		,
		ReturnType< $bog_rec_app_screen['html'] >
	>
	type $mol_view__sub_bog_rec_app_21 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click_bog_rec_app_22 = $mol_type_enforce<
		ReturnType< $bog_rec_app['row_seek'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__title_bog_rec_app_23 = $mol_type_enforce<
		ReturnType< $bog_rec_app['row_title'] >
		,
		ReturnType< $mol_button_minor['title'] >
	>
	export class $bog_rec_app extends $mol_page {
		files( next?: readonly(File)[] ): readonly(File)[]
		...
		Side( ): $mol_view
		screen( ): string
		Screen( ): $bog_rec_app_screen
		Split( ): $mol_view
		row_seek( id: any, next?: any ): any
	...
	export class $bog_rec_app_screen extends $mol_view {
		html( ): string
		dom_name( ): string
		minimal_height( ): number
		attr( ): ({ 
			'srcdoc': ReturnType< $bog_rec_app_screen['html'] >,
		}) 
	}
...
declare namespace $.$$ {
     ...
     */
    class $bog_rec_app extends $.$bog_rec_app {
        files(next?: readonly File[]): readonly File[];
        ...
        drive(player: $bog_rec_play, task: () => Promise<unknown>): void;
        toggle(): void;
        run(): void;
    }
}
